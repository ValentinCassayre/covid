...
def graph_country(country_data, y1, y2):
    ...
    # mat plot lib
        ...
        plt.title("Graph of the evolution of the COVID in EU")
        plt.legend(loc='upper left')
        plt.xlabel('Date')
        plt.ylabel('Cases')
        plt.savefig("{} covid.{}".format(country_data[0][data_dict["CountryExp"]], graph_format),
                    dpi=None, facecolor='w', edgecolor='w', papertype=None, format=graph_format,
